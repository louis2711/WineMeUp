...
ActiveRecord::Schema.define(version: 2020_06_03_131116) do
  ...
  create_table "user_favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["bottle_id"], name: "index_user_favorites_on_bottle_id"
  ...
  create_table "user_profiles", force: :cascade do |t|
    ...
    t.string "color"
    t.integer "user_id"
    t.string "vineyard_management"
    t.string "region"
    t.string "country"
    t.string "selected_aroma"
    t.string "selected_grape"
  end
  ...
  add_foreign_key "user_favorites", "bottles"
